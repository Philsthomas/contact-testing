...
export function RadioButtonElement(props) {
  ...
  return (
    <div className="elementBox">
      <Form onSubmit={submit}>
        <Layout>
          <Layout.Section>
            <h3 className="elementTitle">{t('Elements.radioButtons')}<div className="closeElement"><Tooltip content={t("Elements.closeElement")}><Button icon={XIcon} onClick={() => CloseElement(elementDetails, setEditElement, setElement)}></Button></Tooltip></div></h3>
            <Box className="elementContent">
              ...
              />
              <TextField
                label={t('Elements.defaultValueRadioButtonValue')}
                autoComplete="off"
                {...fields.defaultValue}
              />
              <Checkbox
